...
export default function Footer() {
  return (
    <footer className="bg-[#15211A] text-center text-[#658372] flex flex-col gap-2 p-4 items-center">
      ...
      <h2 className="text-[#04B06C] text-lg font-bold mt-4">Get Latest News</h2>
      ...
      <div className="flex bg-[#111A14]  rounded-full border border-green-900 h-14 p-1 items-center gap-4 ">
        ...
        <form className="w-5/12 flex">
          <input type="email" placeholder="Your Email" className="bg-[#111A14] font-bold " />
          <button className="font-bold text-white text-sm px-4 h-12 rounded-full bg-[#00AA63]">Subscribe</button>
        </form>
      </div>
      <h2 className="text-[#04B06C] font-bold text-lg mt-4">Payment Accepted</h2>
