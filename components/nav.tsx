...
export default function Nav() {
  return (
    <div className="h-16 lg:h-24">
      <div className="fixed top-0 left-0 w-screen h-16 z-10 bg-white flex justify-around items-center px-4 lg:h-24">
        ...
        <img src="/lghome/smicon.png" className="hidden lg:block w-9 mx-7" />

        <div className="hidden lg:flex items-center text-[#243F2F] font-bold text-xl gap-6">
          ...
          <img src="/lghome/tastydaily.png" className="h-10 hidden lg:block mx-4" />
