        ...
        <div className="h-full bg-white border border-gray-300 flex flex-col sm:flex-row">
          ...
          <div className="w-full bg-white">
            <section className="p-9 overflow-clip ">
              ...
              <p className="text-1xl py-2 font-normal mb-6">{desc}</p>

              {rating > 0 && (
                <div className="rating pointer-events-none m-4 ">
                  <input
                    type="radio"
                    name={`rating-${uniqueStars}-fullpage`}
            ...
            <footer className="p-9 ">
              <div className="flex gap-4 items-baseline mb-4">
                ...
                <h3 className="font-semibold text-[#00AA63] sm:text-[1.75vw]">
                  ${price}
                </h3>
              </div>
              ...
              <div className="flex gap-4 items-center">
                <div className="flex gap-2 p-2 border border-black w-min rounded-3xl">
                  <button
                    className="w-9 sm:text-[1.5vw]"
                    disabled={amount === 1}
                    onClick={() => setAmount((old) => old - 1)}
                  >
                    −
                  </button>
                  <h2 className="w-5 grid place-items-center sm:text-[1.25vw]">
                    {amount}
                  </h2>
                  <button
                    className="w-9 sm:text-[1.5vw]"
                    disabled={amount === stock - sold}
                    onClick={() => setAmount((old) => old + 1)}
                  >
                    +
                  </button>
                ...
                <button
                  className="flex gap-4 rounded-full p-6 text-white bg-limeGreen hover:bg-green-950 transition-all duration-300"
                  onClick={cartButton}
                >
