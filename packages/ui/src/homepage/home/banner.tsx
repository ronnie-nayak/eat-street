    ...
    <div>
      <div className="h-[29.5vh] md:h-[40vh] xl:h-[52vh] px-4 py-8 xl:p-14 xl:py-20" style={{
        ...
        <div className="flex flex-col xl:flex-row gap-4 items-start xl:items-center xl:mt-12 xl:sm:text-[1.25vw]">
          <Link href={"/homepage/fruit"} className="flex gap-3 bg-limeGreen text-white p-4 rounded-full xl:p-6 hover:text-limeGreen hover:bg-white transition-all duration-300">
