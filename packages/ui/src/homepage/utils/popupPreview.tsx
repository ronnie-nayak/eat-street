      ...
      <Dialog>
        ...
        <DialogContent className="w-9/12 h-[80vh] bg-transparent border-none">
          <div className="relative">
            <DialogClose className="absolute right-5 -top-5 z-10 h-16 w-16 rounded-full self-end bg-white font-bold sm:text-[1.25vw] border-2 border-gray-700 text-gray-700">X</DialogClose>
