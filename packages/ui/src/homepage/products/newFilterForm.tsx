          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Min Price of the product</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Max Price of the product</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    type="number"
                    placeholder="Enter rating level"
                    min={1}
                    {...field}
                  />
                </FormControl>
                <FormDescription>Rating of the product</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
